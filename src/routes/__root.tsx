...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Platform pengajuan cuti pegawai PNS yang cepat, transparan, dan terintegrasi." },
      { property: "og:title", content: "SICUTI — Sistem Informasi Cuti Pegawai PNS" },
      { property: "og:description", content: "Ajukan cuti, pantau persetujuan, dan kelola riwayat cuti PNS dalam satu platform terintegrasi." },
